<%@ Page Title="" Language="C#" MasterPageFile="~/CenterManager/managerMaster.Master" AutoEventWireup="true" CodeBehind="frmManagerReports.aspx.cs" Inherits="BitsAndBytesProject.CenterManager.WebForm5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="DataTables/pdfmake-0.1.36/vfs_fonts.js"></script>
     <script>
         $(document).ready(function () {
             $.ajax({
                 url: 'ManagerService.asmx/GetAttendanceData',
                 method: 'post',
                 crossDomain: true,
    ...
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Manager Generate Attendance Reports</h4>
                <br />
