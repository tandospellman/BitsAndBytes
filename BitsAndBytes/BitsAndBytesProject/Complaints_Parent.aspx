<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Complaints_Parent.aspx.cs" Inherits="BitsAndBytes.Complaints_Parent" %>
...
<head runat="server">
	...
	<!-- Font Awesome JS -->
	<script defer ="https://use.fontawesome.com/releases/v5.0.13/js/solid.js" integrity="sha384-tzzSw1/Vo+0N5UhStP3bvwWPq+uvzCMfrN1fEFe+xBmv1C/AtVX5K0uZtmcHitFZ" crossorigin="anonymous"></script>
	<script defer ="https://use.fontawesome.com/releases/v5.0.13/js/fontawesome.js" integrity="sha384-6OIrr52G08NpOFSZdxxz1xdNSndlD4vdcf/q2myIUVO0VsqaGHJsB0RaBE01VTOY" crossorigin="anonymous"></script>
    <style type="text/css">
        #divStudentInfo {
            margin-left: 80px;
        }
    ...
    <form id="frmAddCustomer" runat="server">
			...
			<nav class="sidebar" id="sidebar">
				...
				<h2 cssclass="h1">
					<a> Create  
                            ...
                            <img alt="ccc" class="auto-style6" src="images/bbimages/complaint.png" />Complaint</h2>
				<!-- Page Body -->
				<div id="regForm" style="position:relative">

					 <fieldset id="fsContact" runat="server">
                        <h2 class="fsTitle">Complaint info:</h2>
                        <div>
                            
                            <div class="inputContainer">
                                <asp:Label runat="server" AssociatedControlID="cmbSelectStudent" Text="Select Child:" Font-Size="X-Large" Width="205px"></asp:Label>
                               
                                  
                           
							<asp:DropDownList ID="cmbSelectStudent" CssClass="textBox" runat="server" OnSelectedIndexChanged="cmbSelectStudent_SelectedIndexChanged" AutoPostBack="True" Width="215px" DataSourceID="DSStudents" DataTextField="firstName" DataValueField="firstName">
                            ...
                            <div class="inputContainer">
                                <asp:Label runat="server" AssociatedControlID="txtMessage" Text="Topic: " Font-Size="X-Large" Width="205px"></asp:Label>
                      
                           
                                <asp:TextBox runat="server" CssClass="textBox" ID="txtMessage" TextMode="MultiLine"></asp:TextBox>
							 ...
							 <div class="inputContainer">
                                <asp:Label runat="server" AssociatedControlID="txtComplaintT" Text="Description : " Font-Size="X-Large" Width="205px"></asp:Label>
                            <span>
                           
                            
                            

                                        <asp:TextBox CssClass="textBox" id="txtComplaintT" runat="server"></asp:TextBox>
                    ...
                    <div runat="server" id="divUpdateStudent">
                        ...
                        <div runat="server" id="divStudentInfo">
							...
							<div>
								<div>
                                    <div class="inputContainer">
                            <asp:SqlDataSource ID="DSStudents" runat="server" ConnectionString="<%$ ConnectionStrings:BitesandbytesConnectionString %>" SelectCommand="SELECT [firstname] FROM [Student] WHERE ([parentID] = @parentID)">
         ...
         <asp:Label ID="lblmessage0" runat="server" ></asp:Label>
                        ...
                        <div>
							...
							<asp:Button ID="btnSubmit" CssClass="mainButton" runat="server" Text="Submit Complaint" OnClick="btnSubmit_Click" Width="154px"/>
							<asp:Button ID="btnView0" CssClass="mainButton" runat="server" Text="View Messages" OnClick="btnMessage_Click" Width="154px"/>
